      ...
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong>{{ __('Registra tu usuario') }}</strong></h4>
          ...
          <div class="card-body ">
            <p class="card-description text-center">{{ __('Registro manual') }}</p>
            ...
            <div class="bmd-form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mt-3">
              ...
              @if ($errors->has('password_confirmation'))
                <div id="password_confirmation-error" class="error text-danger pl-3" for="password_confirmation" style="display: block;">
                  <strong>{{ $errors->first('confirma tu contraseña') }}</strong>
                </div>
              @endif
            </div>
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg">{{ __('Fin de registro') }}</button>
          </div>
        </div>
      </form>
    </div>
